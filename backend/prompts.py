...
TOOL_PROMPTS: Dict[str, str] = {
    ...
    "vocab": (
        ...
        "  \"pronunciation\": \"<American-English respelling pronunciation of the word, with syllables separated by ' · ' (space middle-dot space) and the STRESSED syllable in UPPERCASE — e.g. astonished → 'uh · STAW · nuhsht', resilient → 'ri · ZIL · yuhnt', photography → 'fuh · TOG · ruh · fee'. EMPTY STRING if input is a multi-word phrase or a non-English word.>\",\n"
        ...
        "}\n"
        "PRONUNCIATION RULES (Merriam-Webster respelling style — NOT IPA):\n"
        ...
        "→ If input contains spaces / hyphens / non-Latin script / numbers, return EMPTY STRING.\n"
