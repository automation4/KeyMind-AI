...
CHAT_SYSTEM_MESSAGE = (
    ...
    "  Translation: \"<Latin / Roman transliteration — e.g. Hinglish, Konglish, Tanglish>\"\n"
    "\n"
    "  Casual/Short Version on how natives speak:\n"
    "  \"<one short colloquial version the way locals actually say it>\"\n"
    "\n"
    "  Quick Tip:\n"
    ...
    "• The 'Translation:' line MUST contain ONLY Latin letters (a-z, A-Z) — no native script.\n"
