...
export const TOOLS: ToolDef[] = [
  ...
  { id: "ask", label: "Ask AI", icon: "help-circle", description: "Open-ended AI assistant", accent: "orange" },
  { id: "paraphrase", label: "Paraphrase", icon: "shuffle", description: "Rewrite differently (3 options)", accent: "mint", multi: true },
  { id: "emoji", label: "Emoji", icon: "happy", description: "Suggest relevant emojis", accent: "yellow" },
